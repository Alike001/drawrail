...
describe("stable policy reason vocabulary", () => {
  it("keeps every required reason code mapped to interface copy", () => {
    expect(REASON_CODES).toEqual([
      ...
      "LOWER_RANKED", "PYTH_NOT_ENABLED", "PYTH_UNAVAILABLE", "PYTH_NOT_ENTITLED",
      "PYTH_FEED_MISSING", "PYTH_STALE", "PYTH_SESSION_INVALID", "PYTH_LOW_PUBLISHER_COUNT",
      "PYTH_CONFIDENCE_TOO_WIDE", "PYTH_UNIT_UNVERIFIED", "PYTH_DIVERGENCE", "PYTH_VALID",
    ]);
